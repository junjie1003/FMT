...
def data_helper(dataset, protected):
    ...
    if task == "Adult-Race":
        data = [
            ...
            [0.840716, 0.837621, 0.848235, 0.843812, 0.833788, 0.844992, 0.840495, 0.839463, 0.838947, 0.843960],  # SUPP
        ...
        data = [
            ...
            [0.845360, 0.853173, 0.848161, 0.843960, 0.849340, 0.846466, 0.845655, 0.846023, 0.847866, 0.849856],  # SUPP
        ...
        data = [
            ...
            [0.900077, 0.894720, 0.897343, 0.892205, 0.892861, 0.895704, 0.895813, 0.900732, 0.897781, 0.894392],  # SUPP
        ...
        data = [
            ...
            [0.646677, 0.650459, 0.647758, 0.646137, 0.642896, 0.643976, 0.647218, 0.654241, 0.641815, 0.653160],  # SUPP
        ...
        data = [
            ...
            [0.641815, 0.652620, 0.643976, 0.646137, 0.639654, 0.649379, 0.647218, 0.647758, 0.636953, 0.646137],  # SUPP
        ...
        data = [
            ...
            [0.723333, 0.713333, 0.736667, 0.710000, 0.730000, 0.686667, 0.756667, 0.743333, 0.743333, 0.693333],  # SUPP
        ...
        data = [
            ...
            [0.733333, 0.690000, 0.696667, 0.740000, 0.733333, 0.776667, 0.710000, 0.710000, 0.713333, 0.743333],  # SUPP
...
def main(opt):
    ...
    labels = ["REW", "ADV", "CARE", "SUPP", "FMT$_s$", "FMT$_d$"]
    colors = [
        (255 / 255.0, 0 / 255.0, 0 / 255.0),  # 红色
        (255 / 255.0, 140 / 255.0, 0 / 255.0),  # 深橙色
    ...
    plt.savefig(fname="../RQ5_results/boxplot/boxplot_acc_%s-%s.pdf" % (opt.dataset, opt.protected), bbox_inches="tight")
